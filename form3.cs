...
namespace Steganography
{
    public partial class form3 : Form
    {
        ...
        private void En_imageBrowse_btn_Click(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                loadedTrueImagePath = openFileDialog1.FileName;
                En_Image_txtbox.Text = loadedTrueImagePath;
        ...
        private void En_fileBrowse_btn_Click(object sender, EventArgs e)
        {
            if (openFileDialog2.ShowDialog() == DialogResult.OK)
            {
                loadedFilePath = openFileDialog2.FileName;
                En_fileBrowse_txtbox.Text = loadedFilePath;
        ...
        private void Encrypt_btn_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                return;
            if (En_Image_txtbox.Text == String.Empty || En_fileBrowse_txtbox.Text == String.Empty)
            {
        ...
        private void EncryptLayer()
        {
            ...
            label3.Text = "Encrypted image has been successfully saved.";
            EncriptionDone = true;
        ...
        private void DecryptLayer()
        {
            ...
            label3.Text = "Decrypted file has been successfully saved.";
            Application.DoEvents();
        }
         ...
         if (openFileDialog3.ShowDialog() == DialogResult.OK)
            {
                ...
                float fs = (float)imginf.Length / 1024;
                label14.Text = smalldecimal(fs.ToString(), 2) + " KB";
                label15.Text = DecryptedImage.Height.ToString() + " Pixel";
                label13.Text = DecryptedImage.Width.ToString() + " Pixel";
                double cansave = (8.0 * ((height * (width / 3) * 3) / 3 - 1)) / 1024;
                label12.Text = smalldecimal(cansave.ToString(), 2) + " KB";
